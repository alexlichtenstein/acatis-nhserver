...
app.layout = html.Div([
    html.Div([
        ...
        html.H1("Acatis Factors Import", style={'margin': '0', 'padding': '10px'}),
    ...
    dcc.Tabs([
        ...
        dcc.Tab(label='Unternehmens Übersicht', children=[
            html.Div([
                ...
                html.Button('Search by ISIN', id='add-company-button'),
        ...
        dcc.Tab(label='ESG Daten', children=[
            html.Div(""),
            html.Label("Filters:"),  # Add a label for the filters
            html.Div(""),
            ...
            dcc.Input(
                id='isins-input',
                type='text',
                placeholder='Enter ISINS (comma-separated)',
        ...
        dcc.Tab(label='Manuelle Daten-Import', children=[
            ...
            html.Button("Run Script", id="run-script-button"),
            html.Pre(id="output"),
        ]),
        ...
        dcc.Tab(label='Faktoren bearbeiten', children=[
            html.Div([
                ...
                html.Div([
                    ...
                    html.Button('Add New Column', id='add-column-button'),
        ...
        try:
            ...
            if triggered_id == 'add-column-button.n_clicks':
                if not new_column_name:
                    raise ValueError("Please enter a column name")
                ...
                success_message = f"New column '{new_column_name}' added successfully!"
